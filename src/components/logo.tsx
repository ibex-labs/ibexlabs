...
export const TSFull = (props: any) => (
  <Tooltip title={"Typescript"} {...props}>
    <TSFullLogo />
  </Tooltip>
);
export const Postgres = (props: any) => (
  <Tooltip title={"PostgreSQL"} {...props}>
    <PG />
  </Tooltip>
);
export const PostgresFull = (props: any) => (
  <Tooltip title={"PostgreSQL"} {...props}>
    <PG />
  </Tooltip>
);
...
export const Supabase = (props: any) => (
  <Tooltip title={"Supabase"} {...props}>
    <SB />
  </Tooltip>
);
export const Vercel = (props: any) => (
  <Tooltip title={"Vercel"} {...props}>
    <VercelLogo />
  </Tooltip>
);
export const Solana = (props: any) => (
  <Tooltip title={"Solana"} {...props}>
    <SolanaLogo />
  </Tooltip>
);
export const Redis = (props: any) => (
  <Tooltip title={"Redis"} {...props}>
    <RedisLogo />
  </Tooltip>
);
export const Rust = (props: any) => (
  <Tooltip title={"Rust"} {...props}>
    <RustLogo />
  </Tooltip>
);
export const RustFull = (props: any) => (
  <Tooltip title={"Rust"} {...props}>
    <RustFullLogo />
  </Tooltip>
);
export const Deno = (props: any) => (
  <Tooltip title={"Deno"} {...props}>
    <DenoLogo />
  </Tooltip>
);
export const Go = (props: any) => (
  <Tooltip title={"Golang"} {...props}>
    <GoLogo />
  </Tooltip>
);
export const GoFull = (props: any) => (
  <Tooltip title={"Golang"} {...props}>
    <GoFullLogo />
  </Tooltip>
);
export const Python = (props: any) => (
  <Tooltip title={"Python"} {...props}>
    <PythonLogo />
  </Tooltip>
);
export const PythonFull = (props: any) => (
  <Tooltip title={"Python"} {...props}>
    <PythonFullLogo />
  </Tooltip>
);
export const Scala = (props: any) => (
...
export const Haskell = (props: any) => (
  <Tooltip title={"Haskell"} {...props}>
    <HaskellLogo />
  </Tooltip>
);
export const HaskellFull = (props: any) => (
  <Tooltip title={"Haskell"} {...props}>
    <HaskellFullLogo />
  </Tooltip>
);
export const Clojure = (props: any) => (
  <Tooltip title={"Clojure"} {...props}>
    <ClojureLogo />
  </Tooltip>
);
export const ClojureFull = (props: any) => (
  <Tooltip title={"Clojure"} {...props}>
    <ClojureFullLogo />
  </Tooltip>
);
export const Kubernetes = (props: any) => (
  <Tooltip title={"Kubernetes"} {...props}>
    <KubernetesLogo />
  </Tooltip>
);
export const Docker = (props: any) => (
  <Tooltip title={"Docker"} {...props}>
    <DockerLogo />
  </Tooltip>
);
export const Grafana = (props: any) => (
  <Tooltip title={"Grafana"} {...props}>
    <GrafanaLogo />
  </Tooltip>
);
export const Prometheus = (props: any) => (
  <Tooltip title={"Prometheus"} {...props}>
    <PrometheusLogo />
  </Tooltip>
);
export const Render = (props: any) => (
  <Tooltip title={"Render"} {...props}>
    <RenderLogo />
  </Tooltip>
);
export const Render1 = (props: any) => (
  <Tooltip title={"Render"} {...props}>
    <RenderLogo1 />
  </Tooltip>
);

export const Rust1 = (props: any) => (
  <Tooltip title={"Rust"} {...props}>
    <RustWhiteLogo />
  </Tooltip>
);
